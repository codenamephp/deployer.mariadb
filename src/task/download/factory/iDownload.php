...
/**
 * Interface for abstract factories to create instances of \de\imxnet\deployer\mariadb\task\download\iDownload at runtime so they can be used in other tasks
 */
interface iDownload {
   ...
   * @return \de\codenamephp\deployer\mariadb\task\download\iDownload
   */
